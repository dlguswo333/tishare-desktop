  ...
  return (
    <nav className={grow ? 'Nav Grow' : 'Nav'}>
      ...
      <div className='Body'>
        ...
        <JobView ind={200} items={{}} state={{state: STATE.RQR_RECV_REQUEST, speed: 110203, progress: 100, id: 'mason', itemName: 'files_that_has_too_long_file_name.jpg', ind: 200, fingerprint: '123123123123123123123123123123123123123123123123123123123123123123123123'}} />
        <JobView ind={300} items={{}} state={{state: STATE.SENDING, speed: 11033403, progress: 60, id: 'july', itemName: 'report about theme ui.docx', totalProgress: '1/2', ind: 300, fingerprint: '123123123123123123123123123123123123123123123123123123123123123123123123'}} /> */}
